...
export const workData = [
  ...
  },
  {
    title: "El-Dokan",
    description: "Frontend Dev.",
    bgImage: "/el-dokan/home.png",
    images: [
      "/el-dokan/home.png",
      "/el-dokan/home2.png",
      "/el-dokan/home3.png",
      "/el-dokan/cart.png",
      "/el-dokan/checkout.png",
      "/el-dokan/login.png",
      "/el-dokan/account.png",
      "/el-dokan/wishlist.png",
    ],
    link: "https://el-dokan.vercel.app/",
    longDescription:
      "A collaborative e-commerce platform built as part of a cross-functional team, delivering a fully responsive shopping experience across devices. I worked as the Frontend Developer alongside two teammates responsible for the .NET backend development, crafting the entire Angular frontend with TypeScript, RxJS, and Angular Material. The platform integrates product catalog, cart, checkout, authentication, and order management features through REST APIs provided by the backend team. Built scalable, reusable UI components with routing, reactive forms, and state management patterns to ensure maintainability and a smooth, reliable user experience from browsing to purchase.",
    technologies: ["Angular", "TypeScript", "RxJS", "Angular Material", ".NET Web API", "REST APIs"],
    role: "Frontend Developer",
    year: "2026",
    github: "https://github.com/Mazin-emad/angular-ecommerce-catalog",
    liveDemoMessage: "Backend under development",
  },
  {
    title: "ESKON",
    description: "Frontend Dev.",
